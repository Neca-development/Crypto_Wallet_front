...
export class solanaService {
    ...
    getTokensByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // USDT Balance
            const info = yield this.connection.getTokenAccountsByOwner(new PublicKey(address), {
    ...
    send20Token(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transaction = new solanaWeb3.Transaction().add(Token.createTransferInstruction(TOKEN_PROGRAM_ID, fromTokenAccount.address, toTokenAccount.address, this.address.publicKey, [], data.amount * 100));
            const signature = yield solanaWeb3.sendAndConfirmTransaction(this.connection, transaction, [this.address], {
