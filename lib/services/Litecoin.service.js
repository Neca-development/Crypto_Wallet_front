...
export class litecoinService {
    ...
    sendMainToken(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sochain_network = 'LTC', privateKey = data.privateKey, sourceAddress = this.keys.publicKey, satoshisPerByte = 20, utxos = yield axios.get(`https://sochain.com/api/v2/get_tx_unspent/${sochain_network}/${sourceAddress}`), 
            // @ts-ignore
