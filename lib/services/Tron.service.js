...
export class tronService {
    ...
    getTokensByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            tokens.push(this.generateTokenObject(USDTTokenBalance, 'Tether USDT', 'custom', trxToUSD.data.usd, trxToUSD.data.usdt, tronUSDTContractAddress));
            return tokens;
        });
    }
    getFeePriceOracle() {
    ...
    generateTokenObject(balance, tokenName, tokenType, trxToUSD, trxToCustomToken, contractAddress) {
