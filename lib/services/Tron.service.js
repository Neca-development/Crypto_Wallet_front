...
export class tronService {
    ...
    getTokensByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const USDTTokenBalance = yield this.getCustomTokenBalance(address, 'TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t');
            tokens.push(this.generateTokenObject(this.Tron.fromSun(nativeTokensBalance), 'TRX', 'native', trxToUSD.tron.usd));
            tokens.push(this.generateTokenObject(USDTTokenBalance, 'Tether USDT', 'custom', trxToUSD.tron.usd, 'TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t'));
            return tokens;
        });
    }
    getFeePriceOracle() {
