...
import { harmonyProvider, imagesURL, bitqueryProxy, harmonyUSDTContractAddress, } from '../constants/providers';
...
export class harmonyService {
    ...
    getTokensByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const USDTTokenBalance = yield this.getCustomTokenBalance(address, harmonyUSDTContractAddress);
