...
import { harmonyProvider, imagesURL, harmonyUSDTContractAddress, } from '../constants/providers';
...
export class harmonyService {
    ...
    getTokensByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const nativeTokensBalance = yield this.web3.eth.getBalance(ethAddress);
            const USDTTokenBalance = yield this.getCustomTokenBalance(ethAddress, harmonyUSDTContractAddress);
            tokens.push(this.generateTokenObject(Number(this.web3.utils.fromWei(nativeTokensBalance)), 'ONE', imagesURL + 'ONE.svg', 'native', oneToUSD.data.usd));
            tokens.push(this.generateTokenObject(USDTTokenBalance, 'Tether USDT', imagesURL + 'USDT.svg', 'custom', oneToUSD.data.usd, oneToUSD.data.usdt, harmonyUSDTContractAddress));
            return tokens;
        });
    }
    getFeePriceOracle() {
    ...
    getTransactionsHistoryByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield axios.post(harmonyProvider, {
                jsonrpc: 2.0,
    ...
    sendMainToken(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.web3.eth.sendTransaction(transactionObject);
    ...
    send20Token(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contract = new this.web3.eth.Contract(oneUSDTAbi, tokenAddress);
    ...
    getCustomTokenBalance(address, contractAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const contract = new this.web3.eth.Contract(oneUSDTAbi, contractAddress);
