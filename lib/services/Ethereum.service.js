...
export class ethereumService {
    ...
    getTokensByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const mainToken = yield this.web3.eth.getBalance(this.web3.eth.defaultAccount);
            const mainTokenBalanceInUSD = Math.trunc(+this.web3.utils.fromWei(mainToken) * ethToUSD.ethereum.usd * 100) / 100;
            tokens.push({
                balance: +this.web3.utils.fromWei(mainToken),
