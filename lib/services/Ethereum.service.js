...
import { etherScanApi, etherScanApiKey, ethWeb3Provider, coinConverterApi, etherUSDTContractAddress, } from '../constants/providers';
...
export class ethereumService {
    ...
    getTokensByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decimals = getNumberFromDecimal(+(yield contract.methods.decimals().call()));
