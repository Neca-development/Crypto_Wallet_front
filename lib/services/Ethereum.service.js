...
export class ethereumService {
    ...
    getTokensByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            tokens.push(this.generateTokenObject(Number(this.web3.utils.fromWei(nativeTokensBalance)), 'ETH', 'native', ethToUSD.ethereum.usd));
            tokens.push(this.generateTokenObject(USDTTokenBalance, 'Tether USDT', 'custom', ethToUSD.ethereum.usd, etherUSDTContractAddress));
            return tokens;
        });
    }
