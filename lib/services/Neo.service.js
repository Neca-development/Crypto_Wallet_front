    ...
    getTokensByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const balance of balanceResponse.balance) {
                ...
                console.log('%cMyProject%cline:104%ctokenNameResponse', 'color:#fff;background:#ee6f57;padding:3px;border-radius:2px', 'color:#fff;background:#1f3c88;padding:3px;border-radius:2px', 'color:#fff;background:rgb(118, 77, 57);padding:3px;border-radius:2px', tokenNameResponse, amount);
                //@ts-ignore
                const symbol = atob(tokenNameResponse.stack[0].value);
                console.log('%cMyProject%cline:114%csymbol', 'color:#fff;background:#ee6f57;padding:3px;border-radius:2px', 'color:#fff;background:#1f3c88;padding:3px;border-radius:2px', 'color:#fff;background:rgb(254, 67, 101);padding:3px;border-radius:2px', symbol);
            }
            const tokens = [];
