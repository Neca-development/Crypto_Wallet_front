...
export class bitcoincashService {
    ...
    getFeePriceOracle(from, to, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sochain_network = 'BCH', sourceAddress = from, utxos = yield axios.get(`https://sochain.com/api/v2/get_tx_unspent/${sochain_network}/${sourceAddress}`);
            ...
            const bchToUSD = (yield axios.get(`${backendApi}coins/BCH`, {
                headers: {
                    'auth-client-key': backendApiKey,
                },
            })).data;
