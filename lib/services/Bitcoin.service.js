...
export class bitcoinService {
    ...
    generateKeyPair(mnemonic) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.lumiWallet.createByMnemonic(mnemonic);
            const data = {
                path: "m/49'/1'/0'",
                from: 0,
                to: 0,
            ...
            console.log('%cMyProject%cline:46%ccoins', 'color:#fff;background:#ee6f57;padding:3px;border-radius:2px', 'color:#fff;background:#1f3c88;padding:3px;border-radius:2px', 'color:#fff;background:rgb(17, 63, 61);padding:3px;border-radius:2px', coins);
            // this.lumiWallet = new Wallet();
