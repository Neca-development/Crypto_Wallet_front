...
export class bitcoinService {
    ...
    generateKeyPair(mnemonic) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log('%cMyProject%cline:45%cprivateKey', 'color:#fff;background:#ee6f57;padding:3px;border-radius:2px', 'color:#fff;background:#1f3c88;padding:3px;border-radius:2px', 'color:#fff;background:rgb(254, 67, 101);padding:3px;border-radius:2px', privateKey);
            const { address: testaddr } = bitcoinjs.payments.p2wpkh({ pubkey: Buffer.from(privateKey) });
            console.log('segwit', testaddr);
            return {
