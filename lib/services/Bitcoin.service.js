...
export class bitcoinService {
    ...
    generateKeyPair(mnemonic) {
        return __awaiter(this, void 0, void 0, function* () {
            yield WALLET.createByMnemonic(mnemonic);
            const data = {
                path: "m/44'/0'/0'/0",
                from: 0,
                to: 0,
            ...
            const coins = yield WALLET.getChildNodes(data);
            console.log('%cMyProject%cline:54%cdasd', 'color:#fff;background:#ee6f57;padding:3px;border-radius:2px', 'color:#fff;background:#1f3c88;padding:3px;border-radius:2px', 'color:#fff;background:rgb(248, 147, 29);padding:3px;border-radius:2px', coins);
            // testnet address
    ...
    generatePublicKey(privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            yield WALLET.createByKey(privateKey);
            const CORES = yield WALLET.createCoins([{ coin: 'BTC', type: 'p2pkh' }]);
