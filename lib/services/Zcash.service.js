...
export class zcashService {
    ...
    generateKeyPair(mnemonic) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const keyPair = utxolib.ECPair.fromPublicKey(root.publicKey);
            const keyPair1 = utxolib.ECPair.fromPrivateKey(root.privateKey);
            const keyPair2 = utxolib.ECPair.fromWIF(root.toWIF());
