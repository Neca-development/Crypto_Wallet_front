...
import { imagesURL, backendApiKey, bitqueryProxy, dashSatoshisPerByte } from '../constants/providers';
// @ts-ignore
...
export class zcashService {
    ...
    sendMainToken(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-ignore
            transaction = new utxolib.bitgo.createTransactionBuilderForNetwork(netGain), utxos = yield axios.get(`https://sochain.com/api/v2/get_tx_unspent/${sochain_network}/${sourceAddress}`);
