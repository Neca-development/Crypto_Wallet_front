...
import { etherScanApi, etherScanApiKey, coinConverterApi, binanceWeb3Provider, binanceUSDTContractAddress, } from '../constants/providers';
...
export class binanceService {
    ...
    getTokensByAddress(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decimals = getNumberFromDecimal(parseInt(yield contract.methods._decimals().call(), 10));
    ...
    send20Token(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decimals = getNumberFromDecimal(+(yield contract.methods._decimals().call()));
