...
const Tron_service_1 = require("./services/Tron.service");
...
class Wallet {
     ...
     */
    async getTransactionsHistoryByAddress(pageNumber, pageSize, tokenType) {
        try {
        ...
        try {
            switch (+chainId) {
                case enums_1.ChainIds['Ethereum']:
                    ...
                    break;
                case enums_1.ChainIds['Tron']:
                    this.service = new Tron_service_1.tronService();
                    break;
