...
export class Wallet {
    ...
    getTotalBalanceInUSD() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const tokens = requestInterval > 60000 ? yield this.getTokensByAddress() : this.data.tokens;
                const balance = tokens.reduce((balance, x) => balance + x.balanceInUSD, 0);
                return Math.trunc(balance * 100) / 100;
            }
            catch (error) {
                throw new CustomError(`An error occurred while receiving balance info from ${this.chainId} network`, 4, ErrorsTypes['Network error'], error);
            }
        });
    }
    /**
    ...
    getTokensByAddress() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                this.data.tokens = yield this.service.getTokensByAddress(this.data.publicKey);
