...
export class Wallet {
    ...
    sendMainToken(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const txHash = yield this.service.sendMainToken(data);
            console.log('%cMyProject%cline:125%ctxHash', 'color:#fff;background:#ee6f57;padding:3px;border-radius:2px', 'color:#fff;background:#1f3c88;padding:3px;border-radius:2px', 'color:#fff;background:rgb(251, 178, 23);padding:3px;border-radius:2px', txHash);
            return txHash;
        });
    }
    /**
