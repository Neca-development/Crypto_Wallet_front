...
import {MainnetConfig, TestnetConfig} from '@avalabs/avalanche-wallet-sdk';
...
export class avalancheService implements IChainService {
     ...
     */
    private convertTransactionToCommonFormat(txData: any, address:string, tokenPriceToUSD: number, direction: 'IN' | 'OUT'): ITransaction {
